...
const UserInfo = ({ userData }) => {
    ...
    return (<>
        ...
        <div className="nav-userInfo-header">
            ...
            <span className="nav-userInfo-header-name">{userData?.name || "Chưa có tài khoản"}</span>
        </div>
        ...
        <div className="nav-userInfo-detail">
            ...
            <div className="nav-userInfo-detail-items">
                ...
                <span className="nav-userInfo-detail-items-content">{`${day}/${month}/${year}` || "Chưa có thông tin"}</span>
            </div>
            <div className="nav-userInfo-detail-items">
