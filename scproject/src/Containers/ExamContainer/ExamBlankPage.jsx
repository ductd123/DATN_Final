...
const ExamBlankPage = () => {
    return (<div className="exam-blank">
        <div className="exam-blank-title">Tính năng dành cho người dùng</div>
        <div className="exam-blank-more">WeTalk cung cấp tính năng kiểm tra nhằm giúp người dùng luyện tập vốn từ vựng ngôn ngữ ký hiệu nhanh chóng.</div>
