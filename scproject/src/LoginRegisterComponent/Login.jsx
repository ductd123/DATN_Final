                    ...
                    <div className="login-right">
                        ...
                        <div className="login-detail">
                            <div class="login-input ">
                                <i class="fa-solid fa-envelope"></i>
                                <input class="login-user" type="email" placeholder="Email" />
                            </div>
                            <div class="login-input ">
                                <i class="fa-solid fa-lock"></i>
                                <input class="login-pass" type="password" name="" placeholder="Password" />
                            </div>

                            <div className="login-button">'
                                <button className="login-input buttoni ">Login</button>
                            </div>
                        </div>
